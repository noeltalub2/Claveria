...
const getTicket = async (req, res) => {
	...
	doc.fontSize(10)
		.fillColor("grey")
		.text("Thank you for choosing our service!", 50, 320, {
			align: "center",
			width: 500,
		});
